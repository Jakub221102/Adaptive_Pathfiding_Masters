...
from src.algorithms.hpa.abstract_graph_builder import AbstractGraphBuilder
from src.algorithms.hpa.abstract_search import AbstractSearch
from src.algorithms.hpa.cluster_builder import (
    build_allowed_positions_by_cluster,
    build_clusters,
    build_cluster_lookup,
)
from src.algorithms.hpa.entrance_detector import EntranceDetector
from src.algorithms.hpa.hpa_tracer import build_hpa_steps_from_edges
from src.algorithms.hpa.local_path_cache import LocalPathCache
...
class HPAStar(PathfindingAlgorithm):
    ...
    def find_path(
        ...
        abstract_edges = self._abstract_search.find_edge_path(
            graph=query_graph,
        ...
        self._last_query_stats = HPAQueryStats(
            ...
            local_path_cache_hits=self._local_path_cache.hits - cache_hits_before,
            local_path_cache_misses=self._local_path_cache.misses - cache_misses_before,
        )
